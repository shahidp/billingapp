...
export class TransactionService {
  ...
  protected convertDateFromClient(transaction: ITransaction): ITransaction {
    const copy: ITransaction = Object.assign({}, transaction, {
      trnDate: transaction.trnDate != null && transaction.trnDate.isValid() ? transaction.trnDate.format(DATE_FORMAT) : null,
      createdDate: transaction.createdDate != null && transaction.createdDate.isValid() ? transaction.createdDate.toJSON() : null,
      lastModifiedDate:
        transaction.lastModifiedDate != null && transaction.lastModifiedDate.isValid() ? transaction.lastModifiedDate.toJSON() : null
    });
    return copy;
  }
  ...
  protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
    if (res.body) {
      res.body.trnDate = res.body.trnDate != null ? moment(res.body.trnDate) : null;
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((transaction: ITransaction) => {
        transaction.trnDate = transaction.trnDate != null ? moment(transaction.trnDate) : null;
        transaction.createdDate = transaction.createdDate != null ? moment(transaction.createdDate) : null;
        transaction.lastModifiedDate = transaction.lastModifiedDate != null ? moment(transaction.lastModifiedDate) : null;
      });
    }
    return res;
  }
