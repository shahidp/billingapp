...
/**
 * REST controller for managing {@link com.wyob.billingapp.domain.Payment}.
 */
@RestController
@RequestMapping("/api")
public class PaymentResource {
     ...
     */
    @GetMapping("/payments")
    public ResponseEntity<List<PaymentDTO>> getAllPayments(PaymentCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
