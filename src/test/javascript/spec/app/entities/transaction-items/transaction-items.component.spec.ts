...
import { TransactionItemsComponent } from 'app/entities/transaction-items/transaction-items.component';
...
describe('Component Tests', () => {
  describe('TransactionItems Management Component', () => {
    let comp: TransactionItemsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TransactionItemsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.transactionItems[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
